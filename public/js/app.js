	...
	module.exports = Index = (function() {
	  ...
	  Index.prototype.getNewVectorPos = function() {
	    ...
	    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
	      ...
	      diff = center.sub(this.mainSphere.position);
	      length = diff.length();
	      diff.normalize();
	    ...
	    for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
	      ...
	      _results.push((function() {
	        ...
	        for (_j = 0, _len1 = face.length; _j < _len1; _j++) {
	          ...
	          z = vertex.z;
	          params = {
	            x: vertex.x + face.diff.x,
	            y: vertex.y + face.diff.y,
	            z: vertex.z + face.diff.z,
	            delay: i * 0.005,
	  ...
	  Index.prototype.update = function(time) {
	    ...
	    return this.mainSphere.geometry.colorsNeedUpdate = true;
	  };
